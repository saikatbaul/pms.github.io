			...
			<form method="post">
				...
				<div class="inset">
					<p>
						...
						<input type="text" name="medicineName" id="medicineName" onkeyup="checkMedicineName()" onblur="checkMedicineName()" value="<?php echo $medicines['medicineName']; ?>">
					</p>
					<span id="medicineNameErr"></span><span class="error"><?php echo $medicineNameErr;?></span>

					<p>
						<label for="pricePerPiece">PRICE PER PIECE</label>
						<input type="text" name="pricePerPiece" id="pricePerPiece" onkeyup="checkPricePerPiece()" onblur="checkPricePerPiece()" value="<?php echo $medicines['pricePerPiece']; ?>">
					</p>
					<span id="pricePerPieceErr"></span><span class="error"><?php echo $pricePerPieceErr;?></span>

					<p>
						<label for="quantity">QUANTITY</label>
						<input type="text" name="quantity" id="quantity" onkeyup="checkQuantity()" onblur="checkQuantity()" value="<?php echo $medicines['quantity']; ?>">
					</p>
